                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8 mb-3">
                                <h3 class="mb-0"><i class="fa-solid fa-droplet text-success"></i> Color</h3>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush" id="tableColor" style="width: 100%">
            ...
            <div class="col-4">
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-12">
                                <h6 class="mb-2" id="titleHeaderForm"><i class="fa-solid fa-droplet text-success"></i> Nuevo color</h6>
                            </div>
                        </div>
                    </div>
...
@push('scripts')
<script src="{{ asset('paper') }}/js/paper-color.js"></script>
<script>
