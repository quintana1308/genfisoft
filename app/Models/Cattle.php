...
class Cattle extends Model
{
    ...
    public function createCattle($request)
    {
        ...
        Cattle::create([
            ...
            'status_reproductive_id' => $request->statusReproductive,
            'status_productive_id' => $request->statusProductive,
            'date_revision' => $request->dateRevision,
            'owner_id' => $request->owner,
            'father_id' => $request->father,
            'mother_id' => $request->mother,
